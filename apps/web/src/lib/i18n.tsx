...
const fr: Dict = {
  ...
  'shop.howToEarn.body':
    "Joue des matchs classés : +20 coins par partie jouée et +50 de bonus à chaque victoire. Accomplis tes quêtes hebdomadaires (onglet Quêtes de ton profil) — jusqu'à 850 coins par semaine en jouant plusieurs modes et en enchaînant les victoires. Et tente ta chance en pariant sur les tournois en cours (onglet Parier) : une prédiction gagnante double ta mise.",
...
const en: Dict = {
  ...
  'shop.howToEarn.body':
    'Play ranked matches: +20 coins per game played and a +50 bonus for every win. Complete your weekly quests (Quests tab on your profile) — up to 850 coins a week by playing several modes and stacking wins. And try your luck by betting on ongoing tournaments (Bet tab): a winning prediction doubles your stake.',
...
const es: Dict = {
  ...
  'shop.howToEarn.body':
    'Juega partidos clasificados: +20 coins por partida jugada y un bonus de +50 por cada victoria. Completa tus misiones semanales (pestaña Misiones de tu perfil) — hasta 850 coins por semana jugando varios modos y encadenando victorias. Y prueba suerte apostando en los torneos en curso (pestaña Apostar): una predicción ganadora duplica tu apuesta.',
