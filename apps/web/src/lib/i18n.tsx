...
const fr: Dict = {
  ...
  'shop.howToEarn.body':
    "Il n'y a pas encore de moyen de gagner des League Coins. Bientôt, tu en récupéreras en gagnant des matchs (montant variable, avec un bonus pour la victoire), en accomplissant des quêtes hebdomadaires (par ex. jouer une partie dans 2 modes de jeu différents dans la semaine) et en participant aux tournois.",
  'shop.howToEarn.soon': 'Bientôt',
...
const en: Dict = {
  ...
  'shop.howToEarn.body':
    "There's no way to earn League Coins yet. Soon, you'll earn them by winning matches (variable amount, with a bonus for a win), completing weekly quests (e.g. play a game in 2 different game modes within the week) and taking part in tournaments.",
  'shop.howToEarn.soon': 'Soon',
...
const es: Dict = {
  ...
  'shop.howToEarn.body':
    'Todavía no hay forma de ganar League Coins. Pronto los conseguirás ganando partidos (cantidad variable, con una bonificación por victoria), completando misiones semanales (p. ej. jugar una partida en 2 modos de juego diferentes durante la semana) y participando en torneos.',
  'shop.howToEarn.soon': 'Pronto',
