...
export function GameModeSwitch() {
  ...
  return (
    <>
      ...
      {/* Ancré au-dessus de la tab bar mobile (52px + safe-area) quelle que soit
          la hauteur d'écran ; collé en bas sur desktop (pas de tab bar). */}
      <div className="fixed right-3 z-[90] bottom-[calc(52px+env(safe-area-inset-bottom)+16px)] sm:bottom-4">
        {open ? (
