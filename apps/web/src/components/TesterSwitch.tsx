...
export function TesterSwitch() {
  ...
  if (impersonator) {
    return (
      <button
        ...
        className="fixed z-40 bottom-20 lg:bottom-4 right-4 flex items-center gap-2 px-4 py-2.5 rounded-full border border-gold/60 bg-gold/15 glass-strong shadow-lg hover:bg-gold/25 transition-colors animate-pop"
  ...
  return (
    <button
      ...
      disabled={busy}
      className="fixed z-40 bottom-20 lg:bottom-4 right-4 flex items-center gap-2 px-4 py-2.5 rounded-full border border-teal/50 bg-teal-deep/20 glass-strong shadow-lg hover:bg-teal-deep/30 transition-colors disabled:opacity-50 animate-pop"
